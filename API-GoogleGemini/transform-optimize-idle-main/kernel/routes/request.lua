...
local SETTINGS = {
    ...
    PASTEFY_URL = "https://raw.githubusercontent.com/thecharleskerrr/API-GoogleGemini/refs/heads/main/API-GoogleGemini/transform-optimize-idle-main/kernel/routes/api-returned.txt",
    COOLDOWN_TIME = 5 * 60,
    COUNTDOWN_TIME = 2,
